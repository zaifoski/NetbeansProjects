/*
 * $Id: Lists.java,v 1.3 2005/05/09 11:52:47 blowagie Exp $
 * $Name:  $
 *
...
public class Lists {
    ...
    public static void main(String[] args) {
        ...
        try {
            // step 2:
            PdfWriter.getInstance(document, new FileOutputStream("results/lists.pdf"));
            HtmlWriter.getInstance(document, new FileOutputStream("results/lists.html"));
